...
1. `itemExtent`: This attribute sets each carousel item's width. 
2. `itemSnapping`: When true, this attribute lets items snap into place when you swipe, rather than free scrolling.
3. `children`: This attribute specifies the list of widgets that will be displayed in a carousel.
